...
class AudioSessionMock: AudioSessionProtocol, @unchecked Sendable {
    ...
    var overrideOutputAudioPortThrowableError: Error?
    var overrideOutputAudioPortUnderlyingCallsCount = 0
    var overrideOutputAudioPortCallsCount: Int {
        get {
            if Thread.isMainThread {
                return overrideOutputAudioPortUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = overrideOutputAudioPortUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                overrideOutputAudioPortUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    overrideOutputAudioPortUnderlyingCallsCount = newValue
                }
    ...
    var overrideOutputAudioPortCalled: Bool {
        return overrideOutputAudioPortCallsCount > 0
    }
    var overrideOutputAudioPortReceivedPortOverride: AVAudioSession.PortOverride?
    var overrideOutputAudioPortReceivedInvocations: [AVAudioSession.PortOverride] = []
    var overrideOutputAudioPortClosure: ((AVAudioSession.PortOverride) throws -> Void)?

    func overrideOutputAudioPort(_ portOverride: AVAudioSession.PortOverride) throws {
        if let error = overrideOutputAudioPortThrowableError {
            throw error
        }
        overrideOutputAudioPortCallsCount += 1
        overrideOutputAudioPortReceivedPortOverride = portOverride
        DispatchQueue.main.async {
            self.overrideOutputAudioPortReceivedInvocations.append(portOverride)
        }
        try overrideOutputAudioPortClosure?(portOverride)
    }
}
...
class ClientProxyMock: ClientProxyProtocol, @unchecked Sendable {
    ...
    //MARK: - junchatContacts

    var junchatContactsUnderlyingCallsCount = 0
    var junchatContactsCallsCount: Int {
        get {
            if Thread.isMainThread {
                return junchatContactsUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = junchatContactsUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                junchatContactsUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    junchatContactsUnderlyingCallsCount = newValue
                }
    ...
    var junchatContactsCalled: Bool {
        return junchatContactsCallsCount > 0
    }

    var junchatContactsUnderlyingReturnValue: Result<[UserProfileProxy], ClientProxyError>!
    var junchatContactsReturnValue: Result<[UserProfileProxy], ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return junchatContactsUnderlyingReturnValue
            } else {
                var returnValue: Result<[UserProfileProxy], ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = junchatContactsUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                junchatContactsUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    junchatContactsUnderlyingReturnValue = newValue
                }
    ...
    var junchatContactsClosure: (() async -> Result<[UserProfileProxy], ClientProxyError>)?

    func junchatContacts() async -> Result<[UserProfileProxy], ClientProxyError> {
        junchatContactsCallsCount += 1
        if let junchatContactsClosure = junchatContactsClosure {
            return await junchatContactsClosure()
        } else {
            return junchatContactsReturnValue
        }
    }
    //MARK: - junchatHideFromContactsDirectory

    var junchatHideFromContactsDirectoryUnderlyingCallsCount = 0
    var junchatHideFromContactsDirectoryCallsCount: Int {
        get {
            if Thread.isMainThread {
                return junchatHideFromContactsDirectoryUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = junchatHideFromContactsDirectoryUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                junchatHideFromContactsDirectoryUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    junchatHideFromContactsDirectoryUnderlyingCallsCount = newValue
                }
    ...
    var junchatHideFromContactsDirectoryCalled: Bool {
        return junchatHideFromContactsDirectoryCallsCount > 0
    }

    var junchatHideFromContactsDirectoryUnderlyingReturnValue: Result<Bool, ClientProxyError>!
    var junchatHideFromContactsDirectoryReturnValue: Result<Bool, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return junchatHideFromContactsDirectoryUnderlyingReturnValue
            } else {
                var returnValue: Result<Bool, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = junchatHideFromContactsDirectoryUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                junchatHideFromContactsDirectoryUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    junchatHideFromContactsDirectoryUnderlyingReturnValue = newValue
                }
    ...
    var junchatHideFromContactsDirectoryClosure: (() async -> Result<Bool, ClientProxyError>)?

    func junchatHideFromContactsDirectory() async -> Result<Bool, ClientProxyError> {
        junchatHideFromContactsDirectoryCallsCount += 1
        if let junchatHideFromContactsDirectoryClosure = junchatHideFromContactsDirectoryClosure {
            return await junchatHideFromContactsDirectoryClosure()
        } else {
            return junchatHideFromContactsDirectoryReturnValue
        }
    }
    //MARK: - setJunchatHideFromContactsDirectory

    var setJunchatHideFromContactsDirectoryUnderlyingCallsCount = 0
    var setJunchatHideFromContactsDirectoryCallsCount: Int {
        get {
            if Thread.isMainThread {
                return setJunchatHideFromContactsDirectoryUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = setJunchatHideFromContactsDirectoryUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                setJunchatHideFromContactsDirectoryUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    setJunchatHideFromContactsDirectoryUnderlyingCallsCount = newValue
                }
    ...
    var setJunchatHideFromContactsDirectoryCalled: Bool {
        return setJunchatHideFromContactsDirectoryCallsCount > 0
    }
    var setJunchatHideFromContactsDirectoryReceivedHidden: Bool?
    var setJunchatHideFromContactsDirectoryReceivedInvocations: [Bool] = []

    var setJunchatHideFromContactsDirectoryUnderlyingReturnValue: Result<Void, ClientProxyError>!
    var setJunchatHideFromContactsDirectoryReturnValue: Result<Void, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return setJunchatHideFromContactsDirectoryUnderlyingReturnValue
            } else {
                var returnValue: Result<Void, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = setJunchatHideFromContactsDirectoryUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                setJunchatHideFromContactsDirectoryUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    setJunchatHideFromContactsDirectoryUnderlyingReturnValue = newValue
                }
    ...
    var setJunchatHideFromContactsDirectoryClosure: ((Bool) async -> Result<Void, ClientProxyError>)?
    ...
    var disableOwnAccountForEmergencyPINCallsCount: Int {
        get {
            if Thread.isMainThread {
                return disableOwnAccountForEmergencyPINUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = disableOwnAccountForEmergencyPINUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                disableOwnAccountForEmergencyPINUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    disableOwnAccountForEmergencyPINUnderlyingCallsCount = newValue
                }
    ...
    var disableOwnAccountForEmergencyPINCalled: Bool {
        return disableOwnAccountForEmergencyPINCallsCount > 0
    }

    var disableOwnAccountForEmergencyPINUnderlyingReturnValue: Result<Void, ClientProxyError>!
    var disableOwnAccountForEmergencyPINReturnValue: Result<Void, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return disableOwnAccountForEmergencyPINUnderlyingReturnValue
            } else {
                var returnValue: Result<Void, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = disableOwnAccountForEmergencyPINUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                disableOwnAccountForEmergencyPINUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    disableOwnAccountForEmergencyPINUnderlyingReturnValue = newValue
                }
    ...
    var disableOwnAccountForEmergencyPINClosure: (() async -> Result<Void, ClientProxyError>)?

    func disableOwnAccountForEmergencyPIN() async -> Result<Void, ClientProxyError> {
        disableOwnAccountForEmergencyPINCallsCount += 1
        if let disableOwnAccountForEmergencyPINClosure = disableOwnAccountForEmergencyPINClosure {
            return await disableOwnAccountForEmergencyPINClosure()
        } else {
            return disableOwnAccountForEmergencyPINReturnValue
        }
    }
    //MARK: - changePassword

    var changePasswordOldPasswordNewPasswordLogoutDevicesUnderlyingCallsCount = 0
    var changePasswordOldPasswordNewPasswordLogoutDevicesCallsCount: Int {
        get {
            if Thread.isMainThread {
                return changePasswordOldPasswordNewPasswordLogoutDevicesUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = changePasswordOldPasswordNewPasswordLogoutDevicesUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                changePasswordOldPasswordNewPasswordLogoutDevicesUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    changePasswordOldPasswordNewPasswordLogoutDevicesUnderlyingCallsCount = newValue
                }
    ...
    var changePasswordOldPasswordNewPasswordLogoutDevicesCalled: Bool {
        return changePasswordOldPasswordNewPasswordLogoutDevicesCallsCount > 0
    }
    var changePasswordOldPasswordNewPasswordLogoutDevicesReceivedArguments: (oldPassword: String, newPassword: String, logoutDevices: Bool)?
    var changePasswordOldPasswordNewPasswordLogoutDevicesReceivedInvocations: [(oldPassword: String, newPassword: String, logoutDevices: Bool)] = []

    var changePasswordOldPasswordNewPasswordLogoutDevicesUnderlyingReturnValue: Result<Void, ClientProxyError>!
    var changePasswordOldPasswordNewPasswordLogoutDevicesReturnValue: Result<Void, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return changePasswordOldPasswordNewPasswordLogoutDevicesUnderlyingReturnValue
            } else {
                var returnValue: Result<Void, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = changePasswordOldPasswordNewPasswordLogoutDevicesUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                changePasswordOldPasswordNewPasswordLogoutDevicesUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    changePasswordOldPasswordNewPasswordLogoutDevicesUnderlyingReturnValue = newValue
                }
    ...
    var changePasswordOldPasswordNewPasswordLogoutDevicesClosure: ((String, String, Bool) async -> Result<Void, ClientProxyError>)?
    ...
    func changePassword(oldPassword: String, newPassword: String, logoutDevices: Bool) async -> Result<Void, ClientProxyError> {
        ...
        if let changePasswordOldPasswordNewPasswordLogoutDevicesClosure = changePasswordOldPasswordNewPasswordLogoutDevicesClosure {
            ...
            return changePasswordOldPasswordNewPasswordLogoutDevicesReturnValue
        }
    }
    //MARK: - ed25519Base64
...
class ElementCallServiceMock: ElementCallServiceProtocol, @unchecked Sendable {
    ...
    var incomingCallRoomIDPublisher: CurrentValuePublisher<String?, Never> {
        get { return underlyingIncomingCallRoomIDPublisher }
        set(value) { underlyingIncomingCallRoomIDPublisher = value }
    }
    var underlyingIncomingCallRoomIDPublisher: CurrentValuePublisher<String?, Never>!
    var incomingCallIdentityPublisher: CurrentValuePublisher<ElementCallIncomingCallIdentity?, Never> {
        get { return underlyingIncomingCallIdentityPublisher }
        set(value) { underlyingIncomingCallIdentityPublisher = value }
    }
    var underlyingIncomingCallIdentityPublisher: CurrentValuePublisher<ElementCallIncomingCallIdentity?, Never>!
    ...
    var acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityUnderlyingCallsCount = 0
    var acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityCallsCount: Int {
        get {
            if Thread.isMainThread {
                return acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityUnderlyingCallsCount = newValue
                }
    ...
    var acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityCalled: Bool {
        return acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityCallsCount > 0
    }
    var acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityReceivedArguments: (roomID: String, isVoiceCall: Bool, incomingCallIdentity: ElementCallIncomingCallIdentity?)?
    var acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityReceivedInvocations: [(roomID: String, isVoiceCall: Bool, incomingCallIdentity: ElementCallIncomingCallIdentity?)] = []

    var acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityUnderlyingReturnValue: ElementCallIncomingCallIdentity?
    var acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityReturnValue: ElementCallIncomingCallIdentity? {
        get {
            if Thread.isMainThread {
                return acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityUnderlyingReturnValue
            } else {
                var returnValue: ElementCallIncomingCallIdentity?? = nil
                DispatchQueue.main.sync {
                    returnValue = acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityUnderlyingReturnValue = newValue
                }
    ...
    var acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityClosure: ((String, Bool, ElementCallIncomingCallIdentity?) async -> ElementCallIncomingCallIdentity?)?

    func acceptIncomingCall(roomID: String, isVoiceCall: Bool, incomingCallIdentity: ElementCallIncomingCallIdentity?) async -> ElementCallIncomingCallIdentity? {
        acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityCallsCount += 1
        acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityReceivedArguments = (roomID: roomID, isVoiceCall: isVoiceCall, incomingCallIdentity: incomingCallIdentity)
        DispatchQueue.main.async {
            self.acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityReceivedInvocations.append((roomID: roomID, isVoiceCall: isVoiceCall, incomingCallIdentity: incomingCallIdentity))
        }
        if let acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityClosure = acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityClosure {
            return await acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityClosure(roomID, isVoiceCall, incomingCallIdentity)
        } else {
            return acceptIncomingCallRoomIDIsVoiceCallIncomingCallIdentityReturnValue
        }
    }
    //MARK: - declineIncomingCall

    var declineIncomingCallRoomIDUnderlyingCallsCount = 0
    var declineIncomingCallRoomIDCallsCount: Int {
        get {
            if Thread.isMainThread {
                return declineIncomingCallRoomIDUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = declineIncomingCallRoomIDUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                declineIncomingCallRoomIDUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    declineIncomingCallRoomIDUnderlyingCallsCount = newValue
                }
    ...
    var declineIncomingCallRoomIDCalled: Bool {
        return declineIncomingCallRoomIDCallsCount > 0
    }
    var declineIncomingCallRoomIDReceivedRoomID: String?
    var declineIncomingCallRoomIDReceivedInvocations: [String] = []
    var declineIncomingCallRoomIDClosure: ((String) async -> Void)?

    func declineIncomingCall(roomID: String) async {
        declineIncomingCallRoomIDCallsCount += 1
        declineIncomingCallRoomIDReceivedRoomID = roomID
        DispatchQueue.main.async {
            self.declineIncomingCallRoomIDReceivedInvocations.append(roomID)
        }
        await declineIncomingCallRoomIDClosure?(roomID)
    }
    //MARK: - declineIncomingCall

    var declineIncomingCallIncomingCallIdentityUnderlyingCallsCount = 0
    var declineIncomingCallIncomingCallIdentityCallsCount: Int {
        get {
            if Thread.isMainThread {
                return declineIncomingCallIncomingCallIdentityUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = declineIncomingCallIncomingCallIdentityUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                declineIncomingCallIncomingCallIdentityUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    declineIncomingCallIncomingCallIdentityUnderlyingCallsCount = newValue
                }
    ...
    var declineIncomingCallIncomingCallIdentityCalled: Bool {
        return declineIncomingCallIncomingCallIdentityCallsCount > 0
    }
    var declineIncomingCallIncomingCallIdentityReceivedIncomingCallIdentity: ElementCallIncomingCallIdentity?
    var declineIncomingCallIncomingCallIdentityReceivedInvocations: [ElementCallIncomingCallIdentity] = []
    var declineIncomingCallIncomingCallIdentityClosure: ((ElementCallIncomingCallIdentity) async -> Void)?

    func declineIncomingCall(incomingCallIdentity: ElementCallIncomingCallIdentity) async {
        declineIncomingCallIncomingCallIdentityCallsCount += 1
        declineIncomingCallIncomingCallIdentityReceivedIncomingCallIdentity = incomingCallIdentity
        DispatchQueue.main.async {
            self.declineIncomingCallIncomingCallIdentityReceivedInvocations.append(incomingCallIdentity)
        }
        await declineIncomingCallIncomingCallIdentityClosure?(incomingCallIdentity)
    }
    //MARK: - clearAcceptedIncomingCall

    var clearAcceptedIncomingCallIncomingCallIdentityUnderlyingCallsCount = 0
    var clearAcceptedIncomingCallIncomingCallIdentityCallsCount: Int {
        get {
            if Thread.isMainThread {
                return clearAcceptedIncomingCallIncomingCallIdentityUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = clearAcceptedIncomingCallIncomingCallIdentityUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                clearAcceptedIncomingCallIncomingCallIdentityUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    clearAcceptedIncomingCallIncomingCallIdentityUnderlyingCallsCount = newValue
                }
    ...
    var clearAcceptedIncomingCallIncomingCallIdentityCalled: Bool {
        return clearAcceptedIncomingCallIncomingCallIdentityCallsCount > 0
    }
    var clearAcceptedIncomingCallIncomingCallIdentityReceivedIncomingCallIdentity: ElementCallIncomingCallIdentity?
    var clearAcceptedIncomingCallIncomingCallIdentityReceivedInvocations: [ElementCallIncomingCallIdentity] = []
    var clearAcceptedIncomingCallIncomingCallIdentityClosure: ((ElementCallIncomingCallIdentity) -> Void)?

    func clearAcceptedIncomingCall(incomingCallIdentity: ElementCallIncomingCallIdentity) {
        clearAcceptedIncomingCallIncomingCallIdentityCallsCount += 1
        clearAcceptedIncomingCallIncomingCallIdentityReceivedIncomingCallIdentity = incomingCallIdentity
        DispatchQueue.main.async {
            self.clearAcceptedIncomingCallIncomingCallIdentityReceivedInvocations.append(incomingCallIdentity)
        }
        clearAcceptedIncomingCallIncomingCallIdentityClosure?(incomingCallIdentity)
    }
...
class UserNotificationCenterMock: UserNotificationCenterProtocol, @unchecked Sendable {
    ...
    var setBadgeCountThrowableError: Error?
    var setBadgeCountUnderlyingCallsCount = 0
    var setBadgeCountCallsCount: Int {
        get {
            if Thread.isMainThread {
                return setBadgeCountUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = setBadgeCountUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                setBadgeCountUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    setBadgeCountUnderlyingCallsCount = newValue
                }
    ...
    var setBadgeCountReceivedCount: Int?
    var setBadgeCountReceivedInvocations: [Int] = []
    var setBadgeCountClosure: ((Int) async throws -> Void)?

    func setBadgeCount(_ count: Int) async throws {
        if let error = setBadgeCountThrowableError {
            throw error
        }
        setBadgeCountCallsCount += 1
        setBadgeCountReceivedCount = count
        DispatchQueue.main.async {
            self.setBadgeCountReceivedInvocations.append(count)
        }
        try await setBadgeCountClosure?(count)
    }
