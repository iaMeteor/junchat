...
struct RoomScreenViewState: BindableState {
    ...
    /// Whether messages sent in this room should be auto-destroyed shortly after sending.
    ...
    /// Whether the current active call invitation has been dismissed from this room screen.
    var hasDismissedActiveCallInvitation = false
