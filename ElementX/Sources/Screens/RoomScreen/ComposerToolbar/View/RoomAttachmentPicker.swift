...
struct RoomAttachmentPicker: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showEmojiPicker) {
            ComposerEmojiPickerSheet(context: context)
        }
    }
...
private struct ComposerEmojiPickerSheet: View {
    @Environment(\.dismiss) private var dismiss
    private let viewModel: EmojiPickerScreenViewModel
