...
extension DynamicTypeSize {
    var junchatUsesSeparateTimelineSendInfo: Bool {
        switch self {
...
struct FormattedBodyText: View {
    ...
    private var additionalWhitespacesSuffix: String {
        guard !dynamicTypeSize.junchatUsesSeparateTimelineSendInfo else {
            return ""
        }
        
        return String.generateBreakableWhitespaceEnd(whitespaceCount: additionalWhitespacesCount, layoutDirection: layoutDirection)
    }
