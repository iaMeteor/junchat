    ...
    var body: some View {
        ZStack {
            TimelineViewRepresentable()
                .opacity(timelineContext.viewState.isEmergencyPrivacyModeEnabled ? 0 : 1)

            if timelineContext.viewState.isEmergencyPrivacyModeEnabled {
