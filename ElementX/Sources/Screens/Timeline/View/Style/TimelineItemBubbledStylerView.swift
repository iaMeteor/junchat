...
private struct PrivacyControlledIndicatorViewModifier: ViewModifier {
    let isVisible: Bool
    let isOutgoing: Bool

    private var alignment: Alignment {
        isOutgoing ? .topTrailing : .topLeading
    }
...
private extension View {
    func privacyControlledIndicator(isVisible: Bool, isOutgoing: Bool) -> some View {
        modifier(PrivacyControlledIndicatorViewModifier(isVisible: isVisible, isOutgoing: isOutgoing))
    }
}
