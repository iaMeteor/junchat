...
struct LocationSharingScreenViewState: BindableState {
    init(interactionMode: LocationSharingInteractionMode,
        ...
        bindings.mapCenterLocation = initialMapCenter
    }
    ...
    var fallbackMarkerKind: LocationMarkerKind? {
        switch interactionMode {
        case .picker:
            return pickerMarkerKind
        case .viewStatic:
...
private extension CLLocationCoordinate2D {
    static let junchatDefaultMapCenter = CLLocationCoordinate2D(latitude: 23.1291, longitude: 113.2644)
}
