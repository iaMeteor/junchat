...
extension HomeScreenRoom {
    init(summary: RoomSummary,
        ...
        self.init(id: roomID,
                  ...
                  lastMessage: hideLastMessage ? AttributedString("隐私保护已开启") : summary.lastMessage,
                  lastMessageState: hideLastMessage ? nil : summary.homeScreenLastMessageState,
