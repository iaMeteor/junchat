...
check_file_contains ElementX/SupportingFiles/target.yml "com.heyujk.junchat.background.refresh" "background task identifier"
check_file_contains ElementX/SupportingFiles/target.yml "applinks:junchat.yyzs120.cn" "junchat applinks domain"
check_file_contains ElementX/SupportingFiles/target.yml "webcredentials:junchat.yyzs120.cn" "junchat webcredentials domain"
...
check_file_contains ElementX/Sources/Application/Settings/AppSettings.swift 'private(set) var accountProviders = ["junchat.yyzs120.cn"]' "default homeserver"
...
check_file_contains ElementX/Sources/Application/Settings/AppSettings.swift 'private(set) var pushGatewayBaseURL: URL = "https://sygnal-junchat.yyzs120.cn"' "push gateway"
...
check_file_contains ElementX/Sources/Screens/CallScreen/View/CallScreen.swift 'livekit_service_url: "https://junchat.yyzs120.cn/livekit/jwt"' "element call livekit config injection"
