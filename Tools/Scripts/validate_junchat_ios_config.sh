...
check_file_contains app.yml "JUNCHAT_PUSH_GATEWAY_BASE_URL: https://sygnal-junchat.yyzs120.cn/junchat-sygnal-v2" "production push gateway"
check_file_contains app.yml "JUNCHAT_DIAGNOSTICS_ENDPOINT: https://junchat.yyzs120.cn/junchat-errors/api/v2/uploads" "production diagnostics endpoint"
...
check_file_contains ElementX/Sources/Services/Environment/JunchatServerEnvironment.swift 'pushGatewayBaseURL: URL(string: "https://sygnal-junchat.yyzs120.cn/junchat-sygnal-v2")' "push gateway"
...
check_file_contains ElementX/Sources/Application/Settings/AppSettings.swift 'diagnosticsEndpoint = serverEnvironment.diagnosticsEndpoint' "environment-backed diagnostics endpoint"
...
check_file_not_contains ElementX/Sources/Other/Logging/MXLog.swift "X-JunChat-Error-Key" "no legacy diagnostics ingest credential"
