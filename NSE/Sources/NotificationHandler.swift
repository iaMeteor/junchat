...
class NotificationHandler {
    ...
    static func junchatCallNotificationSoundName(settings: CommonSettingsProtocol) -> UNNotificationSoundName? {
        guard let soundName = JunchatCallRingtone.ringtone(for: settings.callRingtoneSoundName).soundName else {
            return nil
        }

        return .init(soundName)
    }
    ...
    init(userSession: NSEUserSession,
        ...
        notificationContentBuilder = NotificationContentBuilder(messageEventStringBuilder: eventStringBuilder,
                                                                ...
                                                                callNotificationSoundName: Self.junchatCallNotificationSoundName(settings: settings),
