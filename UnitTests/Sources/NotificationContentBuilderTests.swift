...
struct NotificationContentBuilderTests {
    ...
    init() {
        ...
        notificationContentBuilder = NotificationContentBuilder(messageEventStringBuilder: stringBuilder,
                                                                ...
                                                                callNotificationSoundName: UNNotificationSoundName("junchat-call.caf"),
    ...
    @Test
    mutating func callNotificationUsesSound() async {
        ...
        #expect(notificationContent.body == L10n.notificationIncomingCall)
        #expect(notificationContent.sound != nil)
    }
}
