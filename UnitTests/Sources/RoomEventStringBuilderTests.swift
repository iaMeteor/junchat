...
struct RoomEventStringBuilderTests {
    ...
    func senderPrefix() {
        ...
        #expect(ownMessageString?.string == "\(L10n.commonYou): Hello, World!", "Your own messages should be prefixed with the localized own-user label")
        ...
        #expect(ownPollString?.string == "\(L10n.commonYou): \(L10n.commonPollSummary("Which is better?"))", "Your own polls should be prefixed with the localized own-user label")
